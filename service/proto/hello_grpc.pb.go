...
var file_proto_hello_grpc_proto_rawDesc = []byte{
	...
	0x67, 0x72, 0x70, 0x63, 0x22, 0x22, 0x0a, 0x0c, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x71,
	...
	0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x18, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x5f,
	0x67, 0x72, 0x70, 0x63, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x16, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x48,
...
var file_proto_hello_grpc_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_hello_grpc_proto_goTypes = []interface{}{
	(*HelloRequest1)(nil), // 0: hello_grpc.HelloRequest1
	(*HelloReply)(nil),   // 1: hello_grpc.HelloReply
}
var file_proto_hello_grpc_proto_depIdxs = []int32{
	0, // 0: hello_grpc.Greeter.SayHello:input_type -> hello_grpc.HelloRequest1
	1, // 1: hello_grpc.Greeter.SayHello:output_type -> hello_grpc.HelloReply
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest1, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/hello_grpc.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// GreeterServer is the stream_server API for Greeter service.
...
func (*UnimplementedGreeterServer) SayHello(context.Context, *HelloRequest1) (*HelloReply, error) {
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello_grpc.Greeter/SayHello",
	}
...
var _Greeter_serviceDesc = grpc.ServiceDesc{
	ServiceName: "hello_grpc.Greeter",
	...
	Metadata: "proto/hello_grpc.proto",
}
