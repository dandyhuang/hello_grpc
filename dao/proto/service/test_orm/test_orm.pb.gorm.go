...
/*
Package test_orm is a generated protocol buffer package.
...
// Create ...
func (m *IntPointServiceDefaultServer) Create(ctx context.Context, in *CreateStudentReq) (*CreateStudentRsp, error) {
	out := &CreateStudentRsp{}
	return out, nil
}

// Read ...
func (m *IntPointServiceDefaultServer) Read(ctx context.Context, in *ReadStudentReq) (*ReadStudentRsp, error) {
	db := m.DB
	if custom, ok := interface{}(in).(IntPointServiceUserWithBeforeRead); ok {
		var err error
	...
	out := &ReadStudentRsp{Result: res}
	if custom, ok := interface{}(in).(IntPointServiceUserWithAfterRead); ok {
		var err error
...
// IntPointServiceUserWithBeforeRead called before DefaultReadUser in the default Read handler
type IntPointServiceUserWithBeforeRead interface {
	BeforeRead(context.Context, *gorm1.DB) (*gorm1.DB, error)
}

// IntPointServiceUserWithAfterRead called before DefaultReadUser in the default Read handler
type IntPointServiceUserWithAfterRead interface {
	AfterRead(context.Context, *ReadStudentRsp, *gorm1.DB) error
}
